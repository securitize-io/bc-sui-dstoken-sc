...
export class Rules {
    ...
    async getRules(): Promise<ComplianceRules> {
        ...
        const rules: ComplianceRules = {
            ...
            blockFlowbackEndTime: allFields.block_flowback_end_time_ms && parseInt(allFields.block_flowback_end_time_ms),
            ...
            minimumTotalInvestors: allFields.minimum_total_investors && parseInt(allFields.minimum_total_investors),
